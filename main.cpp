...
int main(int argc, char *argv[])
{
    ...
    if (ConfigManager::s_enableUartMess){
        ...
        using SignalType = void (SerialBridge::*)(quint8 cmd, quint8 func, const QByteArray& param);
        std::vector<SignalType> qml_signal = {
            static_cast<SignalType>(&SerialBridge::to_UartChannel1),
            static_cast<SignalType>(&SerialBridge::to_UartChannel2),
            static_cast<SignalType>(&SerialBridge::to_UartChannel3),
            static_cast<SignalType>(&SerialBridge::to_UartChannel4),
            static_cast<SignalType>(&SerialBridge::to_UartChannel5),
            static_cast<SignalType>(&SerialBridge::to_UartChannel6),
            static_cast<SignalType>(&SerialBridge::to_UartChannel7),
            static_cast<SignalType>(&SerialBridge::to_UartChannel8),
            static_cast<SignalType>(&SerialBridge::to_UartChannel9),
            static_cast<SignalType>(&SerialBridge::to_UartChannel10),
            static_cast<SignalType>(&SerialBridge::to_UartChannel11),
            static_cast<SignalType>(&SerialBridge::to_UartChannel12),
            static_cast<SignalType>(&SerialBridge::to_UartChannel13),
            static_cast<SignalType>(&SerialBridge::to_UartChannel14),
            static_cast<SignalType>(&SerialBridge::to_UartChannel15),
            static_cast<SignalType>(&SerialBridge::to_UartChannel16),
            static_cast<SignalType>(&SerialBridge::to_UartChannel17),
            static_cast<SignalType>(&SerialBridge::to_UartChannel18),
            static_cast<SignalType>(&SerialBridge::to_UartChannel19),
            static_cast<SignalType>(&SerialBridge::to_UartChannel20),
            static_cast<SignalType>(&SerialBridge::to_UartChannel21),
            static_cast<SignalType>(&SerialBridge::to_UartChannel22),
            static_cast<SignalType>(&SerialBridge::to_UartChannel23),
            static_cast<SignalType>(&SerialBridge::to_UartChannel24),
            static_cast<SignalType>(&SerialBridge::to_UartChannel25),
            static_cast<SignalType>(&SerialBridge::to_UartChannel26),
            static_cast<SignalType>(&SerialBridge::to_UartChannel27),
            static_cast<SignalType>(&SerialBridge::to_UartChannel28),
            static_cast<SignalType>(&SerialBridge::to_UartChannel29),
            static_cast<SignalType>(&SerialBridge::to_UartChannel30),
            static_cast<SignalType>(&SerialBridge::to_UartChannel31),
            static_cast<SignalType>(&SerialBridge::to_UartChannel32),
            static_cast<SignalType>(&SerialBridge::to_UartChannel33),
        };

        for (size_t i = 0; i < Uart_Channels.size(); ++i) {
            // QmlUI -> Uart
            QObject::connect(Uart_bridge.get(),qml_signal[i],Uart_Channels[i].get(),&SerialWorker::writeFrame,Qt::QueuedConnection);
        }
