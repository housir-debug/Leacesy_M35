...
scpi_result_t ScpiManager::sendCmd(scpi_t* context, quint8 cmd, quint8 func, const QByteArray &data) {
    ...
    auto* self = static_cast<ScpiManager*>(context->user_context);
    switch (channel){
        case 1:emit self->sendFrame_Uart4(cmd,func,data);break;
        case 2:emit self->sendFrame_Uart5(cmd,func,data);break;
...
bool ScpiManager::sendQueryCmd(scpi_t* context, quint8 cmd, quint8 func) {
    ...
    switch (channel){
        case 1:emit self->sendFrame_Uart4(cmd,func,"");break;
        case 2:emit self->sendFrame_Uart5(cmd,func,"");break;
