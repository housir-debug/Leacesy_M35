...
bool CanWorker::initializeSocket(const QString &interfaceName)
{
    ...
    connect(notifier, &QSocketNotifier::activated,this, &CanWorker::handleWriteReady);
...
void CanWorker::listenProcessing(quint32 canId,const QString &canface)
{
    if (m_testing.load()) {
        m_receivedCount++;
...
void CanWorker::handleWriteReady(int socketFd)
{
