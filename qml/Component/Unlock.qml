...
Item {
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    gradient: Gradient {
                        ...
                        GradientStop {
                            position: 1.0
                            color: Qt.rgba(240, 240, 240, 0.18)
                        }
                    }
                }
            }
    ...
    MouseArea {
        ...
        readonly property real minX: 9
        readonly property real maxX: parent.width - (sliderContainer.width + 6)
        ...
        onPositionChanged: {
            if (sliderContainer.x >= maxX * 0.96) {
                sliderContainer.x = maxX
                root.unlock()
            }
        }
